...
import mod.krevik.Biomes.GenLayerMysticMain;
...
public class BiomeProviderMystic extends BiomeProvider
{
    ...
    public BiomeProviderMystic(long seed, WorldType worldTypeIn)
    {
        this();

        GenLayer[] agenlayer = GenLayerMysticMain.makeTheWorld(seed);
        agenlayer = getModdedBiomeGenerators(worldTypeIn, seed, agenlayer);
        this.genBiomes = agenlayer[0];
        this.biomeIndexLayer = agenlayer[1];
    }

    public BiomeProviderMystic(WorldInfo info)
    {
    ...
    public Biome[] getBiomes(@Nullable Biome[] listToReuse, int x, int z, int width, int length, boolean cacheFlag)
    {
        ...
        else
        {
            ...
            {
                listToReuse[i] = Biome.getBiome(aint[i], KCore.MysticForest);
            }
