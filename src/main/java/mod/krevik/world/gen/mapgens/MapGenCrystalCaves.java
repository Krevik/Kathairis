...
public class MapGenCrystalCaves extends MapGenBase
{
    ...
    {
        if (p_175793_1_.getBlock() == KCore.MythicStone)
        {
            return true;
        }
        else if (p_175793_1_.getBlock() == KCore.WeatheredRock)
        {
            return true;
        }
        else if (p_175793_1_.getBlock() == KCore.ForgottenSand)
        {
            return true;
        }
        else if (p_175793_1_.getBlock() == KCore.MovingSand)
        {
            return true;
        }
     ...
     */
    protected void recursiveGenerate(World worldIn, int chunkX, int chunkZ, int originalX, int originalZ, ChunkPrimer data)
    {
        ...
        for (int j = 0; j < i; ++j)
        {
            ...
            double d1 = (double)this.rand.nextInt(this.rand.nextInt(40) + 8);
                ...
                for(int j1=-radius;j1<radius;j1++){
                    for(int k1=-radius;k1<radius;k1++){
                        if(i1*i1+j1*j1+k1*k1<radius*radius){
                                data.setBlockState(originalX*16+8 + i1, (int) d1 + j1, originalZ*16+8 + k1, BLK_AIR);
                        }
                    }
                }
            }
