...
import static mod.krevik.kathairis.init.ModItems.CRYSTAL_CLUSTER;
import static mod.krevik.kathairis.init.ModItems.MYSTIC_CHESTPLATE;
import static mod.krevik.kathairis.init.ModItems.MYSTIC_GEM;
import static mod.krevik.kathairis.init.ModItems.MYSTIC_PICKAXE;
import static mod.krevik.kathairis.init.ModItems.MYSTIC_SWORD;
