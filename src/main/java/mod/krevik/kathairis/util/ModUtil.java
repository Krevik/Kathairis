...
public final class ModUtil {
	...
	/**
	 * Utility method to make sure that all our items appear on the search tab and any other tab they specify
	 *
	...
	public static double map(final double input, final double inputStart, final double inputEnd, final double outputStart, final double outputEnd) {
		final double inputRange = inputEnd - inputStart;
		final double outputRange = outputEnd - outputStart;
