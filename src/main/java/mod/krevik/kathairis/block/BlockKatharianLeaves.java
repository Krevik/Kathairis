...
import static mod.krevik.kathairis.init.ModBlocks.SHINY_LEAVES;
import static mod.krevik.kathairis.init.ModBlocks.SHINY_LOG;
import static mod.krevik.kathairis.init.ModBlocks.SOUL_LEAVES;
...
public class BlockKatharianLeaves extends BlockLeaves {
	...
	static boolean isLeaves(Block block) {
		return block instanceof BlockKatharianLeaves || block instanceof BlockLeaves || block == MYSTIC_LEAVES || block == SOUL_LEAVES ||
				block == SHINY_LEAVES;
	}

	static boolean isLog(Block block) {
		return block instanceof BlockLog || block instanceof BlockKatharianLog || block == MYSTIC_LOG || block == SOUL_LOG ||
				block == SHINY_LOG;
	}
