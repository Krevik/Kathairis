...
public class BlockMysticMetalTrapdoor extends BaseBlock
{
    ...
    public static final PropertyEnum<BlockMysticMetalTrapdoor.DoorHalf> HALF = PropertyEnum.<BlockMysticMetalTrapdoor.DoorHalf>create("half", BlockMysticMetalTrapdoor.DoorHalf.class);
    ...
    {
        return (face == EnumFacing.UP && state.getValue(HALF) == BlockMysticMetalTrapdoor.DoorHalf.TOP || face == EnumFacing.DOWN && state.getValue(HALF) == BlockMysticMetalTrapdoor.DoorHalf.BOTTOM) && !((Boolean)state.getValue(OPEN)).booleanValue() ? BlockFaceShape.SOLID : BlockFaceShape.UNDEFINED;
    }
