...
public class BlockMysticFence extends BaseBlock
{
    ...
    public boolean canConnectTo(IBlockAccess worldIn, BlockPos pos, EnumFacing facing)
    {
        ...
        boolean flag = blockfaceshape == BlockFaceShape.MIDDLE_POLE && (iblockstate.getMaterial() == this.material || block instanceof BlockFenceGate || block instanceof BlockMysticFenceGate);
    ...
    public boolean canBeConnectedTo(IBlockAccess world, BlockPos pos, EnumFacing facing)
    {
        ...
        if(connector instanceof BlockMysticFence)
        {
            ...
            else return this != Blocks.NETHER_BRICK_FENCE || connector == Blocks.NETHER_BRICK_FENCE;
        }
        return false;
    }
