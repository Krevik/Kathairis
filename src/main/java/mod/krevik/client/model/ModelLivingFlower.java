...
public class ModelLivingFlower extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) { 
        ...
        GlStateManager.pushMatrix();
        GlStateManager.translate(this.Lisc3.offsetX, this.Lisc3.offsetY, this.Lisc3.offsetZ);
        GlStateManager.translate(this.Lisc3.rotationPointX * f5, this.Lisc3.rotationPointY * f5, this.Lisc3.rotationPointZ * f5);
        GlStateManager.scale(0.5D, 0.5D, 0.5D);
        GlStateManager.translate(-this.Lisc3.offsetX, -this.Lisc3.offsetY, -this.Lisc3.offsetZ);
        GlStateManager.translate(-this.Lisc3.rotationPointX * f5, -this.Lisc3.rotationPointY * f5, -this.Lisc3.rotationPointZ * f5);
        ...
        GlStateManager.popMatrix();
        GlStateManager.pushMatrix();
        GlStateManager.translate(this.Pylek.offsetX, this.Pylek.offsetY, this.Pylek.offsetZ);
        GlStateManager.translate(this.Pylek.rotationPointX * f5, this.Pylek.rotationPointY * f5, this.Pylek.rotationPointZ * f5);
        ...
        GlStateManager.popMatrix();
        GlStateManager.pushMatrix();
        GlStateManager.translate(this.MLisc4.offsetX, this.MLisc4.offsetY, this.MLisc4.offsetZ);
        GlStateManager.translate(this.MLisc4.rotationPointX * f5, this.MLisc4.rotationPointY * f5, this.MLisc4.rotationPointZ * f5);
        GlStateManager.scale(0.5D, 0.5D, 0.5D);
        GlStateManager.translate(-this.MLisc4.offsetX, -this.MLisc4.offsetY, -this.MLisc4.offsetZ);
        GlStateManager.translate(-this.MLisc4.rotationPointX * f5, -this.MLisc4.rotationPointY * f5, -this.MLisc4.rotationPointZ * f5);
        ...
        GlStateManager.pushMatrix();
        GlStateManager.translate(this.Lisc2.offsetX, this.Lisc2.offsetY, this.Lisc2.offsetZ);
        GlStateManager.translate(this.Lisc2.rotationPointX * f5, this.Lisc2.rotationPointY * f5, this.Lisc2.rotationPointZ * f5);
        GlStateManager.scale(0.5D, 0.5D, 0.5D);
        GlStateManager.translate(-this.Lisc2.offsetX, -this.Lisc2.offsetY, -this.Lisc2.offsetZ);
        GlStateManager.translate(-this.Lisc2.rotationPointX * f5, -this.Lisc2.rotationPointY * f5, -this.Lisc2.rotationPointZ * f5);
        ...
        GlStateManager.popMatrix();
        GlStateManager.pushMatrix();
        GlStateManager.translate(this.Lisc1.offsetX, this.Lisc1.offsetY, this.Lisc1.offsetZ);
        GlStateManager.translate(this.Lisc1.rotationPointX * f5, this.Lisc1.rotationPointY * f5, this.Lisc1.rotationPointZ * f5);
        GlStateManager.scale(0.5D, 0.5D, 0.5D);
        GlStateManager.translate(-this.Lisc1.offsetX, -this.Lisc1.offsetY, -this.Lisc1.offsetZ);
        GlStateManager.translate(-this.Lisc1.rotationPointX * f5, -this.Lisc1.rotationPointY * f5, -this.Lisc1.rotationPointZ * f5);
        ...
        GlStateManager.popMatrix();
        GlStateManager.pushMatrix();
        GlStateManager.translate(this.MLisc1.offsetX, this.MLisc1.offsetY, this.MLisc1.offsetZ);
        GlStateManager.translate(this.MLisc1.rotationPointX * f5, this.MLisc1.rotationPointY * f5, this.MLisc1.rotationPointZ * f5);
        GlStateManager.scale(0.5D, 0.5D, 0.5D);
        GlStateManager.translate(-this.MLisc1.offsetX, -this.MLisc1.offsetY, -this.MLisc1.offsetZ);
        GlStateManager.translate(-this.MLisc1.rotationPointX * f5, -this.MLisc1.rotationPointY * f5, -this.MLisc1.rotationPointZ * f5);
        ...
        GlStateManager.popMatrix();
        GlStateManager.pushMatrix();
        GlStateManager.translate(this.MLisc2.offsetX, this.MLisc2.offsetY, this.MLisc2.offsetZ);
        GlStateManager.translate(this.MLisc2.rotationPointX * f5, this.MLisc2.rotationPointY * f5, this.MLisc2.rotationPointZ * f5);
        GlStateManager.scale(0.5D, 0.5D, 0.5D);
        GlStateManager.translate(-this.MLisc2.offsetX, -this.MLisc2.offsetY, -this.MLisc2.offsetZ);
        GlStateManager.translate(-this.MLisc2.rotationPointX * f5, -this.MLisc2.rotationPointY * f5, -this.MLisc2.rotationPointZ * f5);
        ...
        GlStateManager.popMatrix();
        GlStateManager.pushMatrix();
        GlStateManager.translate(this.MLisc3.offsetX, this.MLisc3.offsetY, this.MLisc3.offsetZ);
        GlStateManager.translate(this.MLisc3.rotationPointX * f5, this.MLisc3.rotationPointY * f5, this.MLisc3.rotationPointZ * f5);
        GlStateManager.scale(0.5D, 0.5D, 0.5D);
        GlStateManager.translate(-this.MLisc3.offsetX, -this.MLisc3.offsetY, -this.MLisc3.offsetZ);
        GlStateManager.translate(-this.MLisc3.rotationPointX * f5, -this.MLisc3.rotationPointY * f5, -this.MLisc3.rotationPointZ * f5);
        ...
        GlStateManager.pushMatrix();
        GlStateManager.translate(this.Lisc4.offsetX, this.Lisc4.offsetY, this.Lisc4.offsetZ);
        GlStateManager.translate(this.Lisc4.rotationPointX * f5, this.Lisc4.rotationPointY * f5, this.Lisc4.rotationPointZ * f5);
        GlStateManager.scale(0.5D, 0.5D, 0.5D);
        GlStateManager.translate(-this.Lisc4.offsetX, -this.Lisc4.offsetY, -this.Lisc4.offsetZ);
        GlStateManager.translate(-this.Lisc4.rotationPointX * f5, -this.Lisc4.rotationPointY * f5, -this.Lisc4.rotationPointZ * f5);
        ...
        GlStateManager.popMatrix();
        GlStateManager.pushMatrix();
        GlStateManager.translate(this.Lisc5.offsetX, this.Lisc5.offsetY, this.Lisc5.offsetZ);
        GlStateManager.translate(this.Lisc5.rotationPointX * f5, this.Lisc5.rotationPointY * f5, this.Lisc5.rotationPointZ * f5);
        GlStateManager.scale(0.5D, 0.5D, 0.5D);
        GlStateManager.translate(-this.Lisc5.offsetX, -this.Lisc5.offsetY, -this.Lisc5.offsetZ);
        GlStateManager.translate(-this.Lisc5.rotationPointX * f5, -this.Lisc5.rotationPointY * f5, -this.Lisc5.rotationPointZ * f5);
