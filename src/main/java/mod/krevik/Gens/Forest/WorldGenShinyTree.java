package mod.krevik.Gens.Forest;
...
public class WorldGenShinyTree extends WorldGenAbstractBasicMysticTree
{
    ...
    public WorldGenShinyTree(boolean p_i2027_1_)
    {
        this(p_i2027_1_, 4, false);
    }

    public WorldGenShinyTree(boolean notify, int minTreeHeightIn, boolean growVines)
    {
        super(notify);
            ...
            else
            {
                ...
                if ((worldIn.getBlockState(position.down()) == KCore.CorruptedDirt.getDefaultState() || worldIn.getBlockState(position)==KCore.CorruptedDirt.getDefaultState() || state.getBlock() == KCore.CorruptedGrass))
                {
                        ...
                        for (int k1 = position.getX() - j1; k1 <= position.getX() + j1; ++k1)
                        {
                            ...
                            for (int i2 = position.getZ() - j1; i2 <= position.getZ() + j1; ++i2)
                            {
                                ...
                                if (Math.abs(l1) != j1 || Math.abs(j2) != j1 || rand.nextInt(2) != 0 && i4 != 0)
                                {
                                    ...
                                    {
                                        this.setBlockAndNotifyAdequately(worldIn, blockpos, KCore.ShinyLeaves.getDefaultState());
                                    }
                                }
                            }
                        }
                    ...
                    for (int j3 = 0; j3 < i; ++j3)
                    {
                        ...
                        {
                            this.setBlockAndNotifyAdequately(worldIn, position.up(j3), KCore.ShinyLog.getDefaultState());
