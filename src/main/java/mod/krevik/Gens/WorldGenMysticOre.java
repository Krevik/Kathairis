...
public class WorldGenMysticOre extends WorldGenerator
{
    ...
    public WorldGenMysticOre(IBlockState state, int blockCount)
    {
        this.oreBlock = state;
                        ...
                        if (d12 * d12 + d13 * d13 < 1.0D)
                        {
                            for (int j2 = l; j2 <= k1; ++j2)
                            {
                                ...
                                if (d12 * d12 + d13 * d13 + d14 * d14 < 1.0D)
                                {
                                    ...
                                    if (state.getBlock()==KCore.MythicStone || state.getBlock()==KCore.WeatheredRock )
                                    {
                                    	setBlockAndNotifyAdequately(worldIn,blockpos, this.oreBlock);
                                    }
                                }
                            }
                        }
