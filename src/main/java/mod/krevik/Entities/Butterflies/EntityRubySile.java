package mod.krevik.Entities.Butterflies;
...
public class EntityRubySile extends EntityAmbientCreature
{
    private static final DataParameter<Byte> SITTING = EntityDataManager.<Byte>createKey(EntityRubySile.class, DataSerializers.BYTE);
    ...
    {
        EntityLiving.registerFixesMob(fixer, EntityRubySile.class);
    }
