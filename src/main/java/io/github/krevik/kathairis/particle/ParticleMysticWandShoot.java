...
public class ParticleMysticWandShoot extends BasicKatharianParticle {
    public ParticleMysticWandShoot(KatharianParticleTexture parTexDef, World world, double posX, double posY, double posZ, double motionX, double motionY, double motionZ) {
    ...
    public static class Factory implements IParticleFactory<BasicKatharianParticleType> {
        ...
        public Particle makeParticle(BasicKatharianParticleType p_199234_1_, World p_199234_2_, double p_199234_3_, double p_199234_5_, double p_199234_7_, double p_199234_9_, double p_199234_11_, double p_199234_13_) {
            return new ParticleMysticWandShoot(textureConfig,p_199234_2_, p_199234_3_, p_199234_5_, p_199234_7_, p_199234_9_, p_199234_11_, p_199234_13_)
                    .setRotationSpeed(((float) Math.random() - 0.5F) * 0.1F)
                    .setLifeSpan(20+new Random().nextInt(20))
                    .setGravity(0F)
                    .setScale(1F)
