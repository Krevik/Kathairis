...
public class ModEntities {
    ...
    public static EntityType<? extends EntityLiving> BASIC_BUTTERFLY1 = (EntityType<? extends EntityLiving>) EntityType.Builder.create(EntityButterfly.class, EntityButterfly::new).tracker(200, 1, true).customSpawning(null,true).build("common_butterfly1").setRegistryName(MOD_ID,"common_butterfly1");
    public static EntityType<? extends EntityLiving> BASIC_BUTTERFLY2 = (EntityType<? extends EntityLiving>) EntityType.Builder.create(EntityButterfly1.class, EntityButterfly1::new).tracker(200, 1, true).customSpawning(null,true).build("common_butterfly2").setRegistryName(MOD_ID,"common_butterfly2");
    public static EntityType<? extends EntityLiving> CLOUD_SHIMMER = (EntityType<? extends EntityLiving>) EntityType.Builder.create(EntityCloudShimmer.class, EntityCloudShimmer::new).tracker(200, 1, true).customSpawning(null,true).build("cloud_shimmer").setRegistryName(MOD_ID,"cloud_shimmer");
    public static EntityType<? extends EntityLiving> ILLUKINI = (EntityType<? extends EntityLiving>) EntityType.Builder.create(EntityIllukini.class, EntityIllukini::new).tracker(200, 1, true).customSpawning(null,true).build("illukini").setRegistryName(MOD_ID,"illukini");
    public static EntityType<? extends EntityLiving> RUBY_SILE = (EntityType<? extends EntityLiving>) EntityType.Builder.create(EntityRubySile.class, EntityRubySile::new).tracker(200, 1, true).customSpawning(null,true).build("ruby_sile").setRegistryName(MOD_ID,"ruby_sile");
    public static EntityType<? extends EntityLiving> SKYLIGHT = (EntityType<? extends EntityLiving>) EntityType.Builder.create(EntitySkylight.class, EntitySkylight::new).tracker(200, 1, true).customSpawning(null,true).build("skylight").setRegistryName(MOD_ID,"skylight");
    public static EntityType<? extends EntityLiving> BIG_TURTLE = (EntityType<? extends EntityLiving>) EntityType.Builder.create(EntityBigTurtle.class, EntityBigTurtle::new).tracker(32, 1, true).customSpawning(null,true).build("big_turtle").setRegistryName(MOD_ID,"big_tortoise");
    public static EntityType<? extends EntityLiving> BISON = (EntityType<? extends EntityLiving>) EntityType.Builder.create(EntityBison.class, EntityBison::new).tracker(32, 1, true).customSpawning(null,true).build("bison").setRegistryName(MOD_ID,"bison");
    public static EntityType<? extends EntityLiving> CACTI_SPORE = (EntityType<? extends EntityLiving>) EntityType.Builder.create(EntityCactiSpore.class, EntityCactiSpore::new).tracker(32, 1, true).customSpawning(null,true).build("cacti_spore").setRegistryName(MOD_ID,"cacti_spore");
    public static EntityType<? extends EntityLiving> CAMEL = (EntityType<? extends EntityLiving>) EntityType.Builder.create(EntityCamel.class, EntityCamel::new).tracker(32, 1, true).customSpawning(null,true).build("camel").setRegistryName(MOD_ID,"camel");
    public static EntityType<? extends EntityLiving> CLOUD_OISTER = (EntityType<? extends EntityLiving>) EntityType.Builder.create(EntityCloudOister.class, EntityCloudOister::new).tracker(32, 1, true).customSpawning(null,true).build("cloud_oister").setRegistryName(MOD_ID,"cloud_oister");
    public static EntityType<? extends EntityLiving> CLOUDY_SLIME = (EntityType<? extends EntityLiving>) EntityType.Builder.create(EntityCloudySlime.class, EntityCloudySlime::new).tracker(32, 1, true).customSpawning(null,true).build("cloudy_slime").setRegistryName(MOD_ID,"cloudy_slime");
    public static EntityType<? extends EntityLiving> FLYING_SQUID = (EntityType<? extends EntityLiving>) EntityType.Builder.create(EntityFlyingSquid.class, EntityFlyingSquid::new).tracker(32, 1, true).customSpawning(null,true).build("flying_squid").setRegistryName(MOD_ID,"flying_squid");
    public static EntityType<? extends EntityLiving> FUNGITE = (EntityType<? extends EntityLiving>) EntityType.Builder.create(EntityFungite.class, EntityFungite::new).tracker(32, 1, true).customSpawning(null,true).build("fungite").setRegistryName(MOD_ID,"fungite");
    public static EntityType<? extends EntityLiving> GAZNOWEL = (EntityType<? extends EntityLiving>) EntityType.Builder.create(EntityGaznowel.class, EntityGaznowel::new).tracker(32, 1, true).customSpawning(null,true).build("gaznowel").setRegistryName(MOD_ID,"gaznowel");
    public static EntityType<? extends EntityLiving> GECKO = (EntityType<? extends EntityLiving>) EntityType.Builder.create(EntityGecko.class, EntityGecko::new).tracker(32, 1, true).customSpawning(null,true).build("gecko").setRegistryName(MOD_ID,"gecko");
    public static EntityType<? extends EntityLiving> HOWLER = (EntityType<? extends EntityLiving>) EntityType.Builder.create(EntityHowler.class, EntityHowler::new).tracker(32, 1, true).customSpawning(null,true).build("howler").setRegistryName(MOD_ID,"howler");
    public static EntityType<? extends EntityLiving> JELLY_FISH = (EntityType<? extends EntityLiving>) EntityType.Builder.create(EntityJellyFish.class, EntityJellyFish::new).tracker(32, 1, true).customSpawning(null,true).build("jelly_fish").setRegistryName(MOD_ID,"jelly_fish");
    public static EntityType<? extends EntityLiving> LIVING_FLOWER = (EntityType<? extends EntityLiving>) EntityType.Builder.create(EntityLivingFlower.class, EntityLivingFlower::new).tracker(32, 1, true).customSpawning(null,true).build("living_flower").setRegistryName(MOD_ID,"living_flower");
    public static EntityType<? extends EntityLiving> MYSTIC_BIRD = (EntityType<? extends EntityLiving>) EntityType.Builder.create(EntityMysticBird.class, EntityMysticBird::new).tracker(32, 1, true).customSpawning(null,true).build("mystic_bird").setRegistryName(MOD_ID,"mystic_bird");
    public static EntityType<? extends EntityLiving> PHASM = (EntityType<? extends EntityLiving>) EntityType.Builder.create(EntityPhasm.class, EntityPhasm::new).tracker(32, 1, true).customSpawning(null,true).build("phasm").setRegistryName(MOD_ID,"phasm");
    public static EntityType<? extends EntityLiving> POISONOUS_SCORPION = (EntityType<? extends EntityLiving>) EntityType.Builder.create(EntityPoisonousScorpion.class, EntityPoisonousScorpion::new).tracker(32, 1, true).customSpawning(null,true).build("poisonous_scorpion").setRegistryName(MOD_ID,"poisonous_scorpion");
    public static EntityType<? extends EntityLiving> SKYRAY = (EntityType<? extends EntityLiving>) EntityType.Builder.create(EntitySkyray.class, EntitySkyray::new).tracker(200, 1, true).customSpawning(null,true).build("skyray").setRegistryName(MOD_ID,"skyray");
    public static EntityType<? extends EntityLiving> STRANGE_WANDERER = (EntityType<? extends EntityLiving>) EntityType.Builder.create(EntityStrangeWanderer.class, EntityStrangeWanderer::new).tracker(200, 1, true).customSpawning(null,true).build("strange_wanderer").setRegistryName(MOD_ID,"strange_wanderer");
