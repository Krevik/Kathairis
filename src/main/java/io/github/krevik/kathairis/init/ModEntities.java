...
public class ModEntities {
    ...
    public static final EntityType<EntityButterfly> COMMON_BUTTERFLY1 = _null();
    public static final EntityType<EntityButterfly1> COMMON_BUTTERFLY2 = _null();
    ...
    public static final EntityType<EntityMysticWandShoot> MYSTIC_WAND_SHOOT = _null();
