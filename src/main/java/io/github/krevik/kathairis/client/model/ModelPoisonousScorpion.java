...
public class ModelPoisonousScorpion<T extends LivingEntity> extends EntityModel<T> {
    ...
    public ModelPoisonousScorpion() {
        ...
        this.Tail12.func_228301_a_(0.0F, 0.0F, 0.0F, 3, 3, 6, 0.0F);
        ...
        this.Tail15.func_228301_a_(0.0F, 0.0F, 0.0F, 1, 1, 5, 0.0F);
        ...
        this.Leg31Child_3.func_228301_a_(-8.0F, 0.0F, 0.0F, 2, 8, 2, 0.0F);
        ...
        this.Leg61Child_1.func_228301_a_(0.0F, 0.0F, 0.0F, 2, 8, 2, 0.0F);
        ...
        this.Leg31Child_2.func_228301_a_(-8.0F, 0.0F, 0.0F, 2, 8, 2, 0.0F);
        ...
        this.Leg31Child_1.func_228301_a_(-8.0F, 0.0F, 0.0F, 2, 8, 2, 0.0F);
        ...
        this.Leg61.func_228301_a_(0.0F, 0.0F, 0.0F, 8, 2, 2, 0.0F);
        ...
        this.Szczypce21.func_228301_a_(0.0F, 0.0F, 0.0F, 2, 2, 8, 0.0F);
        ...
        this.Szczypce11.func_228301_a_(0.0F, 0.0F, 0.0F, 2, 2, 8, 0.0F);
        ...
        this.Leg2_1.func_228301_a_(-8.0F, 0.0F, 0.0F, 8, 2, 2, 0.0F);
        ...
        this.Szczypce21Child.func_228301_a_(0.0F, 0.0F, 0.0F, 6, 4, 4, 0.0F);
        ...
        this.Szczypce21ChildChild_1.func_228301_a_(0.0F, 0.0F, 0.0F, 2, 1, 1, 0.0F);
        ...
        this.Tail4.func_228301_a_(0.0F, 0.0F, 0.0F, 4, 4, 7, 0.0F);
        ...
        this.Szczypce11Child.func_228301_a_(0.0F, 0.0F, 0.0F, 6, 4, 4, 0.0F);
        ...
        this.Szczypce11ChildChild_1.func_228301_a_(0.0F, 0.0F, 0.0F, 3, 1, 1, 0.0F);
        ...
        this.Szczypce21ChildChild.func_228301_a_(0.0F, 0.0F, 0.0F, 4, 2, 2, 0.0F);
        ...
        this.Tail2.func_228301_a_(0.0F, 0.0F, 0.0F, 3, 3, 7, 0.0F);
        ...
        this.Leg61Child_2.func_228301_a_(0.0F, 0.0F, 0.0F, 2, 8, 2, 0.0F);
        ...
        this.Tail13.func_228301_a_(0.0F, 0.0F, 0.0F, 5, 4, 6, 0.0F);
        ...
        this.Leg61Child_3.func_228301_a_(0.0F, 0.0F, 0.0F, 2, 8, 2, 0.0F);
        ...
        this.Leg2_3.func_228301_a_(-8.0F, 0.0F, 0.0F, 8, 2, 2, 0.0F);
        ...
        this.Leg61_2.func_228301_a_(0.0F, 0.0F, 0.0F, 8, 2, 2, 0.0F);
        ...
        this.Tail1.func_228301_a_(0.0F, 0.0F, 0.0F, 4, 4, 7, 0.0F);
        ...
        this.Body_1.func_228301_a_(0.0F, 0.0F, 0.0F, 9, 6, 13, 0.0F);
        this.Leg2 = new ModelRenderer(this, 0, 70);
        this.Leg2.setRotationPoint(-3.5F, 17.2F, -7.2F);
        this.Leg2.func_228301_a_(-8.0F, 0.0F, 0.0F, 8, 2, 2, 0.0F);
        ...
        this.Leg61_1.func_228301_a_(0.0F, 0.0F, 0.0F, 8, 2, 2, 0.0F);
        ...
        this.Tail9.func_228301_a_(0.0F, 0.0F, 0.0F, 4, 4, 6, 0.0F);
        ...
        this.Leg2_2.func_228301_a_(-8.0F, 0.0F, 0.0F, 8, 2, 2, 0.0F);
        ...
        this.Leg61Child.func_228301_a_(0.0F, 0.0F, 0.0F, 2, 8, 2, 0.0F);
        ...
        this.Leg31Child.func_228301_a_(-8.0F, 0.0F, 0.0F, 2, 8, 2, 0.0F);
        ...
        this.Leg61_3.func_228301_a_(0.0F, 0.0F, 0.0F, 8, 2, 2, 0.0F);
        ...
        this.Szczypce11ChildChild.func_228301_a_(0.0F, 0.0F, 0.0F, 4, 2, 2, 0.0F);
        ...
        this.Tail4_1.func_228301_a_(0.0F, 0.0F, 0.0F, 3, 3, 6, 0.0F);
        ...
        this.Body.func_228301_a_(0.0F, 0.0F, 0.0F, 8, 5, 12, 0.0F);
