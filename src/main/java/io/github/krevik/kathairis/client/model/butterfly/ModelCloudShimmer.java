 ...
 */
@OnlyIn(Dist.CLIENT)
public class ModelCloudShimmer<T extends LivingEntity> extends EntityModel<T> {
    ...
    public ModelCloudShimmer() {
        ...
        this.Wing3 = new RendererModel(this, 47, 30);
        ...
        this.Wing4 = new RendererModel(this, 4, 0);
