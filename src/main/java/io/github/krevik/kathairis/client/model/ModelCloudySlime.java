...
public class ModelCloudySlime<T extends LivingEntity> extends AgeableModel<T> {
    ...
    public ModelCloudySlime() {
        ...
        this.shape1_2.func_228301_a_(0.0F, 0.0F, 0.0F, 6, 6, 6, 0.0F);
        ...
        this.shape1_6.func_228301_a_(0.0F, 0.0F, 0.0F, 10, 10, 10, 0.0F);
        ...
        this.shape1_7.func_228301_a_(0.0F, 0.0F, 0.0F, 8, 8, 8, 0.0F);
        ...
        this.shape1_8.func_228301_a_(0.0F, 0.0F, 0.0F, 10, 10, 10, 0.0F);
        ...
        this.shape1_15.func_228301_a_(0.0F, 0.0F, 0.0F, 6, 6, 6, 0.0F);
        ...
        this.shape1_3.func_228301_a_(0.0F, 0.0F, 0.0F, 6, 6, 6, 0.0F);
        this.shape1_10 = new ModelRenderer(this, 0, 0);
        this.shape1_10.setRotationPoint(0.0F, 15.799999999999963F, 7.0F);
        this.shape1_10.func_228301_a_(0.0F, 0.0F, 0.0F, 6, 6, 6, 0.0F);
        ...
        this.shape1_9.func_228301_a_(0.0F, 0.0F, 0.0F, 7, 7, 7, 0.0F);
        ...
        this.shape1_4.func_228301_a_(0.0F, 0.0F, 0.0F, 14, 14, 16, 0.0F);
        ...
        this.shape1_13.func_228301_a_(0.0F, 0.0F, 0.0F, 8, 4, 9, 0.0F);
        ...
        this.shape1_12.func_228301_a_(0.0F, 0.0F, 0.0F, 8, 8, 8, 0.0F);
        ...
        this.shape1_14.func_228301_a_(0.0F, 0.0F, 0.0F, 4, 4, 4, 0.0F);
        this.shape1_5 = new ModelRenderer(this, 0, 0);
        this.shape1_5.setRotationPoint(-8.5F, 14.29999999999997F, -9.0F);
        this.shape1_5.func_228301_a_(0.0F, 0.0F, 0.0F, 18, 7, 19, 0.0F);
    }
