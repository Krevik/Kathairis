...
public class ModelGecko<T extends LivingEntity> extends AgeableModel<T> {
    ...
    public ModelGecko() {
        ...
        this.legmain_2Child.addBox(0.0F, 0.0F, 0.0F, 1, 2, 1, 0.0F);
        ...
        this.legmain_4Child.addBox(0.0F, 0.0F, 0.0F, 1, 2, 1, 0.0F);
        ...
        this.legmain_1Child.addBox(0.0F, 0.0F, 0.0F, 1, 2, 1, 0.0F);
        ...
        this.legmain_3Child.addBox(0.0F, 0.0F, 0.0F, 1, 2, 1, 0.0F);
