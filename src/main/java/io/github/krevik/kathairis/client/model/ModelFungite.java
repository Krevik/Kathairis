...
public class ModelFungite<T extends LivingEntity> extends AgeableModel<T> {
    ...
    public ModelFungite() {
        ...
        this.arm_6.func_228301_a_(0.0F, 0.0F, 0.0F, 3, 10, 3, 0.0F);
        ...
        this.leg25.func_228301_a_(0.0F, 0.0F, 0.0F, 4, 9, 4, 0.0F);
        ...
        this.arm_4.func_228301_a_(0.0F, 0.0F, 0.0F, 9, 3, 3, 0.0F);
        ...
        this.body_4.func_228301_a_(0.0F, 0.0F, 0.0F, 3, 7, 3, 0.0F);
        this.arm_2 = new ModelRenderer(this, 40, 21);
        this.arm_2.setRotationPoint(-6.8F, 0.0F, 0.9F);
        this.arm_2.func_228301_a_(0.0F, 0.0F, 0.0F, 8, 3, 3, 0.0F);
        ...
        this.body_1.func_228301_a_(0.0F, 0.0F, 0.0F, 12, 4, 6, 0.0F);
        ...
        this.arm_1.func_228301_a_(0.0F, 0.0F, 0.0F, 9, 3, 3, 0.0F);
        ...
        this.mouth_layer.func_228301_a_(0.0F, 0.0F, 0.0F, 11, 14, 4, 0.0F);
        this.leg35 = new ModelRenderer(this, 54, 32);
        this.leg35.setRotationPoint(2.9F, 7.9F, 4.0F);
        this.leg35.func_228301_a_(0.0F, 0.0F, 0.0F, 3, 8, 4, 0.0F);
        ...
        this.body_5.func_228301_a_(0.0F, 0.0F, 0.0F, 11, 3, 6, 0.0F);
        this.arm_5 = new ModelRenderer(this, 26, 30);
        this.arm_5.setRotationPoint(6.8F, 1.7F, -0.6F);
        this.arm_5.func_228301_a_(0.0F, 0.0F, 0.0F, 3, 7, 3, 0.0F);
        ...
        this.body_3.func_228301_a_(0.0F, 0.0F, 0.0F, 12, 4, 6, 0.0F);
        ...
        this.arm_8.func_228301_a_(0.0F, 0.0F, 0.0F, 10, 3, 3, 0.0F);
        ...
        this.leg45.func_228301_a_(0.0F, 0.0F, 0.0F, 4, 12, 3, 0.0F);
        ...
        this.leg15.func_228301_a_(0.0F, 0.0F, 0.0F, 4, 7, 4, 0.0F);
        ...
        this.arm_3.func_228301_a_(0.0F, 0.0F, 0.0F, 5, 3, 3, 0.0F);
        ...
        this.body_2.func_228301_a_(0.0F, 0.0F, 0.0F, 13, 5, 6, 0.0F);
    ...
    protected Iterable<ModelRenderer> func_225602_a_() {
        return ImmutableList.of(cap_top);
    }
