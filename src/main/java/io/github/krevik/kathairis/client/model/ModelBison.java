...
public class ModelBison<T extends LivingEntity> extends AgeableModel<T> {
    ...
    public ModelBison() {
        ...
        this.Tail1Child.addBox(0.0F, 0.0F, 0.0F, 1, 2, 1, 0.0F);
        ...
        this.LeftThighChildChild.addBox(0.0F, 0.0F, 0.0F, 3, 7, 3, 0.0F);
        ...
        this.RightThighChildChild.addBox(0.0F, 0.0F, 0.0F, 3, 7, 3, 0.0F);
        this.FrontLeftUpperLegChild = new ModelRenderer(this, 62, 16);
        this.FrontLeftUpperLegChild.setRotationPoint(-1.5F, 4.0F, -1.5F);
        this.FrontLeftUpperLegChild.addBox(0.0F, 0.0F, 0.0F, 3, 7, 3, 0.0F);
