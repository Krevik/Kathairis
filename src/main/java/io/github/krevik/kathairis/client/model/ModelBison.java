...
public class ModelBison<T extends LivingEntity> extends EntityModel<T> {
    ...
    public ModelBison() {
        ...
        this.Tail1 = new RendererModel(this, 62, 0);
        ...
        this.HornLeft = new RendererModel(this, 22, 0);
        ...
        this.BackRightUpperLeg = new RendererModel(this, 0, 16);
        ...
        this.FrontLeftDownLeg = new RendererModel(this, 62, 16);
