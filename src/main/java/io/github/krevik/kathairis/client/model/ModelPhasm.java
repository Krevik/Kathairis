...
public class ModelPhasm<T extends LivingEntity> extends EntityModel<EntityPhasm> {
    ...
    public ModelPhasm() {
        ...
        this.RightArm.func_228301_a_(-1.0F, -2.0F, -2.0F, 4, 12, 4, 0.0F);
        this.setRotateAngle(RightArm, 0.0F, 0.0F, -0.31869712141416456F);
        this.LeftArm = new ModelRenderer(this, 40, 16);
        this.LeftArm.setRotationPoint(-5.0F, 2.0F, 0.0F);
        this.LeftArm.func_228301_a_(-3.0F, -2.0F, -2.0F, 4, 12, 4, 0.0F);
        ...
        this.InnerHead.func_228301_a_(-4.0F, -8.0F, -4.0F, 8, 8, 8, 0.0F);
