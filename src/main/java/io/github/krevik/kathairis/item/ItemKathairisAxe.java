...
public class ItemKathairisAxe extends ItemKathairisTool {
	...
	private static final Set<Block> EFFECTIVE_ON = Sets.newHashSet(
			...
			MYSTIC_LOG, MYSTIC_PLANKS, SHINY_LOG, SHINY_PLANKS, MYSTIC_WOOD_STAIRS, SHINY_WOOD_STAIRS, MYSTIC_WOOD_STAIRS,
			SHINY_WOOD_FENCE, MYSTIC_WOOD_FENCE_GATE, SHINY_WOOD_FENCE_GATE, SOUL_LOG, SOUL_PLANKS, SOUL_WOOD_STAIRS,
			MYSTIC_WOOD_SLAB, SHINY_WOOD_SLAB, SOUL_WOOD_SLAB, MYSTIC_LOG_STRIPPED, SHINY_LOG_STRIPPED, SOUL_LOG_STRIPPED,
			MYSTIC_WOOD_TRAPDOOR, SHINY_WOOD_TRAPDOOR, SOUL_WOOD_TRAPDOOR, MYSTIC_WOOD_DOORS, SHINY_WOOD_DOORS, SOUL_WOOD_DOORS,
			ELDERWILLOW_LOG, ELDERWILLOW_LOG_STRIPPED, ELDERWILLOW_PLANKS, ELDERWILLOW_WOOD_DOORS, ELDERWILLOW_WOOD_FENCE,
			ELDERWILLOW_WOOD_FENCE_GATE,ELDERWILLOW_WOOD_SLAB,ELDERWILLOW_WOOD_STAIRS,ELDERWILLOW_WOOD_TRAPDOOR
	);
	...
	public boolean onBlockDestroyed(ItemStack p_179218_1_, World p_179218_2_, BlockState p_179218_3_, BlockPos p_179218_4_, LivingEntity p_179218_5_) {
		if(p_179218_1_.getItem()== ModItems.MAGNETHIUM_AXE){
