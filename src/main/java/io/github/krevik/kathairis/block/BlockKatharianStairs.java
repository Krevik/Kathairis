...
public class BlockKatharianStairs extends BlockStairs implements IBucketPickupHandler, ILiquidContainer {
	...
	public BlockKatharianStairs(IBlockState modelState, Material material, float hardnessResistance, SoundType soundType) {
	...
	public static boolean isBlockStairs(IBlockState state) {
		return state.getBlock() instanceof BlockStairs || state.getBlock() instanceof BlockKatharianStairs;
	}
