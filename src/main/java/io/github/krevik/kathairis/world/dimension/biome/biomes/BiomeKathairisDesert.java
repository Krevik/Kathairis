...
import static io.github.krevik.kathairis.init.ModBlocks.KATHAIRIS_SANDSTONE;
 ...
 * @author Krevik
 */
public class BiomeKathairisDesert extends BiomeKathairisBiomeBase {

	public static final SurfaceBuilderConfig SAND_SAND_SANDSTONE_SURFACE = new SurfaceBuilderConfig(KATHAIRIS_SAND.getDefaultState(), KATHAIRIS_SANDSTONE.getDefaultState(), SOFT_SAND.getDefaultState());

	public BiomeKathairisDesert() {
		...
		//this.addFeature(GenerationStage.Decoration.TOP_LAYER_MODIFICATION, createCompositeFeature(KathairisFeatureList.LAYERED_HILL, IFeatureConfig.NO_FEATURE_CONFIG, COUNT_RANGE, new CountRangeConfig(1, 0, 0, 128)));
		...
		this.addFeature(GenerationStage.Decoration.SURFACE_STRUCTURES, createCompositeFeature(KathairisFeatureList.KATHAIRIS_ROCK_MUSHROOM, IFeatureConfig.NO_FEATURE_CONFIG, COUNT_RANGE, new CountRangeConfig(12, 0, 0, 128)));
		this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, createCompositeFeature(KathairisFeatureList.KATHAIRIS_DEAD_BUSH, IFeatureConfig.NO_FEATURE_CONFIG, TWICE_SURFACE, new FrequencyConfig(2)));
		this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, createCompositeFeature(KathairisFeatureList.KATHAIRIS_ROCKTUS, IFeatureConfig.NO_FEATURE_CONFIG, TWICE_SURFACE, new FrequencyConfig(2)));
		this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, createCompositeFeature(KathairisFeatureList.KATHAIRIS_CACTUS, IFeatureConfig.NO_FEATURE_CONFIG, TWICE_SURFACE, new FrequencyConfig(10)));
		...
		this.addFeature(GenerationStage.Decoration.UNDERGROUND_DECORATION, createCompositeFeature(KathairisFeatureList.KATHAIRIS_CLOUD_MINI_ISLAND, IFeatureConfig.NO_FEATURE_CONFIG, COUNT_RANGE, new CountRangeConfig(1, 0, 0, 128)));
		//this.addSpawn(EnumCreatureType.CREATURE, new SpawnListEntry((EntityType<? extends EntityLiving>) KathairisEntityTypes.BIG_TURTLE, 12, 1, 1));
		//this.addSpawn(EnumCreatureType.CREATURE, new SpawnListEntry((EntityType<? extends EntityLiving>) KathairisEntityTypes.POISONOUS_SCORPION, 3, 1, 1));
		//this.addSpawn(EnumCreatureType.CREATURE, new SpawnListEntry((EntityType<? extends EntityLiving>) KathairisEntityTypes.CAMEL, 6, 1, 1));
