...
import static io.github.krevik.kathairis.init.ModBlocks.KATHAIRIS_DEAD_GRASS;

/**
 * @author Krevik
 */
public class FeatureKathairisDeadBush extends Feature<NoFeatureConfig> {
	...
	public boolean place(IWorld world, IChunkGenerator<? extends IChunkGenSettings> generator, Random random, BlockPos pos, NoFeatureConfig config) {
		...
		IBlockState iblockstate1 = KATHAIRIS_DEAD_GRASS.getDefaultState();
