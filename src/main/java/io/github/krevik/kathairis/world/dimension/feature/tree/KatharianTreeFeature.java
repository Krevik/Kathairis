...
public class KatharianTreeFeature extends AbstractKatharianTreeFeature {
    ...
    private static final IBlockState DEFAULT_LEAF = ModBlocks.MYSTIC_LEAVES.getDefaultState();
    ...
    private boolean isValidGround(IWorld world, BlockPos pos){
        ...
        return block==ModBlocks.KATHAIRIS_GRASS || block==ModBlocks.KATHAIRIS_DIRT || block== Blocks.GRASS_BLOCK || block== Blocks.DIRT;
    }
}