...
public class FeatureKatharianSwampTallTree1 extends AbstractKatharianTreeFeature {
    private static final IBlockState LOG = ModBlocks.ELDERWILLOW_LOG.getDefaultState();
    private static final IBlockState LEAF = ModBlocks.ELDERWILLOW_LEAVES.getDefaultState();
