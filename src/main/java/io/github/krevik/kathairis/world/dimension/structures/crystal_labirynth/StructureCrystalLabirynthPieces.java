...
public class StructureCrystalLabirynthPieces {
    public static void registerStructurePieces() {
        StructureIO.registerStructureComponent(StructureCrystalLabirynthPieces.Corridor.class, "MSCorridor");
        StructureIO.registerStructureComponent(StructureCrystalLabirynthPieces.Cross.class, "MSCrossing");
        StructureIO.registerStructureComponent(StructureCrystalLabirynthPieces.Room.class, "MSRoom");
        StructureIO.registerStructureComponent(StructureCrystalLabirynthPieces.Stairs.class, "MSStairs");
    }

    private static StructureCrystalLabirynthPieces.Piece createRandomShaftPiece(List<StructurePiece> p_189940_0_, Random p_189940_1_, int p_189940_2_, int p_189940_3_, int p_189940_4_, @Nullable EnumFacing p_189940_5_, int p_189940_6_) {
        int i = p_189940_1_.nextInt(100);
        if (i >= 80) {
            MutableBoundingBox mutableboundingbox = StructureCrystalLabirynthPieces.Cross.findCrossing(p_189940_0_, p_189940_1_, p_189940_2_, p_189940_3_, p_189940_4_, p_189940_5_);
            if (mutableboundingbox != null) {
                return new StructureCrystalLabirynthPieces.Cross(p_189940_6_, p_189940_1_, mutableboundingbox, p_189940_5_);
            }
        } else if (i >= 70) {
            MutableBoundingBox mutableboundingbox1 = StructureCrystalLabirynthPieces.Stairs.findStairs(p_189940_0_, p_189940_1_, p_189940_2_, p_189940_3_, p_189940_4_, p_189940_5_);
            if (mutableboundingbox1 != null) {
                return new StructureCrystalLabirynthPieces.Stairs(p_189940_6_, p_189940_1_, mutableboundingbox1, p_189940_5_);
            }
        } else {
            MutableBoundingBox mutableboundingbox2 = StructureCrystalLabirynthPieces.Corridor.findCorridorSize(p_189940_0_, p_189940_1_, p_189940_2_, p_189940_3_, p_189940_4_, p_189940_5_);
            if (mutableboundingbox2 != null) {
                return new StructureCrystalLabirynthPieces.Corridor(p_189940_6_, p_189940_1_, mutableboundingbox2, p_189940_5_);
            }
        }
    ...
    private static StructureCrystalLabirynthPieces.Piece generateAndAddPiece(StructurePiece p_189938_0_, List<StructurePiece> p_189938_1_, Random p_189938_2_, int p_189938_3_, int p_189938_4_, int p_189938_5_, EnumFacing p_189938_6_, int p_189938_7_) {
        if (p_189938_7_ > 8) {
            return null;
        } else if (Math.abs(p_189938_3_ - p_189938_0_.getBoundingBox().minX) <= 80 && Math.abs(p_189938_5_ - p_189938_0_.getBoundingBox().minZ) <= 80) {
            StructureCrystalLabirynthPieces.Piece mineshaftpieces$piece = createRandomShaftPiece(p_189938_1_, p_189938_2_, p_189938_3_, p_189938_4_, p_189938_5_, p_189938_6_, p_189938_7_ + 1);
    ...
    public static class Corridor extends StructureCrystalLabirynthPieces.Piece {
        ...
        public Corridor(int p_i47140_1_, Random p_i47140_2_, MutableBoundingBox p_i47140_3_, EnumFacing p_i47140_4_) {
            super(p_i47140_1_);
        ...
        public void buildComponent(StructurePiece componentIn, List<StructurePiece> listIn, Random rand) {
            ...
            if (enumfacing != null) {
                switch(enumfacing) {
                    ...
                    default:
                        if (j <= 1) {
                            StructureCrystalLabirynthPieces.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.minZ - 1, enumfacing, i);
                        } else if (j == 2) {
                            StructureCrystalLabirynthPieces.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.minZ, EnumFacing.WEST, i);
                        } else {
                            StructureCrystalLabirynthPieces.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.minZ, EnumFacing.EAST, i);
                        }
                        break;
                    case SOUTH:
                        if (j <= 1) {
                            StructureCrystalLabirynthPieces.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.maxZ + 1, enumfacing, i);
                        } else if (j == 2) {
                            StructureCrystalLabirynthPieces.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.maxZ - 3, EnumFacing.WEST, i);
                        } else {
                            StructureCrystalLabirynthPieces.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.maxZ - 3, EnumFacing.EAST, i);
                        }
                        break;
                    case WEST:
                        if (j <= 1) {
                            StructureCrystalLabirynthPieces.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.minZ, enumfacing, i);
                        } else if (j == 2) {
                            StructureCrystalLabirynthPieces.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.minZ - 1, EnumFacing.NORTH, i);
                        } else {
                            StructureCrystalLabirynthPieces.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.maxZ + 1, EnumFacing.SOUTH, i);
                        }
                        break;
                    case EAST:
                        if (j <= 1) {
                            StructureCrystalLabirynthPieces.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.minZ, enumfacing, i);
                        } else if (j == 2) {
                            StructureCrystalLabirynthPieces.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.maxX - 3, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.minZ - 1, EnumFacing.NORTH, i);
                        } else {
                            StructureCrystalLabirynthPieces.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.maxX - 3, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.maxZ + 1, EnumFacing.SOUTH, i);
                        }
                }
            }
            ...
            if (i < 8) {
                if (enumfacing != EnumFacing.NORTH && enumfacing != EnumFacing.SOUTH) {
                    for(int i1 = this.boundingBox.minX + 3; i1 + 3 <= this.boundingBox.maxX; i1 += 5) {
                        ...
                        if (j1 == 0) {
                            StructureCrystalLabirynthPieces.generateAndAddPiece(componentIn, listIn, rand, i1, this.boundingBox.minY, this.boundingBox.minZ - 1, EnumFacing.NORTH, i + 1);
                        } else if (j1 == 1) {
                            StructureCrystalLabirynthPieces.generateAndAddPiece(componentIn, listIn, rand, i1, this.boundingBox.minY, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, i + 1);
                        }
                    }
                } else {
                    for(int k = this.boundingBox.minZ + 3; k + 3 <= this.boundingBox.maxZ; k += 5) {
                        ...
                        if (l == 0) {
                            StructureCrystalLabirynthPieces.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY, k, EnumFacing.WEST, i + 1);
                        } else if (l == 1) {
                            StructureCrystalLabirynthPieces.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY, k, EnumFacing.EAST, i + 1);
                        }
                    }
                }
            }
    ...
    public static class Cross extends StructureCrystalLabirynthPieces.Piece {
        ...
        public Cross(int p_i47139_1_, Random p_i47139_2_, MutableBoundingBox p_i47139_3_, @Nullable EnumFacing p_i47139_4_) {
            super(p_i47139_1_);
        ...
        public void buildComponent(StructurePiece componentIn, List<StructurePiece> listIn, Random rand) {
            ...
            switch(this.corridorDirection) {
                case NORTH:
                default:
                    StructureCrystalLabirynthPieces.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX + 1, this.boundingBox.minY, this.boundingBox.minZ - 1, EnumFacing.NORTH, i);
                    StructureCrystalLabirynthPieces.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.minZ + 1, EnumFacing.WEST, i);
                    StructureCrystalLabirynthPieces.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY, this.boundingBox.minZ + 1, EnumFacing.EAST, i);
                    break;
                case SOUTH:
                    StructureCrystalLabirynthPieces.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX + 1, this.boundingBox.minY, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, i);
                    StructureCrystalLabirynthPieces.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.minZ + 1, EnumFacing.WEST, i);
                    StructureCrystalLabirynthPieces.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY, this.boundingBox.minZ + 1, EnumFacing.EAST, i);
                    break;
                case WEST:
            ...
            if (this.isMultipleFloors) {
                if (rand.nextBoolean()) {
                    StructureCrystalLabirynthPieces.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX + 1, this.boundingBox.minY + 3 + 1, this.boundingBox.minZ - 1, EnumFacing.NORTH, i);
                }

                if (rand.nextBoolean()) {
                    StructureCrystalLabirynthPieces.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY + 3 + 1, this.boundingBox.minZ + 1, EnumFacing.WEST, i);
                }

                if (rand.nextBoolean()) {
                    StructureCrystalLabirynthPieces.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY + 3 + 1, this.boundingBox.minZ + 1, EnumFacing.EAST, i);
                }

                if (rand.nextBoolean()) {
                    StructureCrystalLabirynthPieces.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX + 1, this.boundingBox.minY + 3 + 1, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, i);
                }
            }
    ...
    public static class Room extends StructureCrystalLabirynthPieces.Piece {
        ...
        public void buildComponent(StructurePiece componentIn, List<StructurePiece> listIn, Random rand) {
            ...
            for(k = 0; k < this.boundingBox.getXSize(); k = k + 4) {
                ...
                StructureCrystalLabirynthPieces.Piece mineshaftpieces$piece = StructureCrystalLabirynthPieces.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX + k, this.boundingBox.minY + rand.nextInt(j) + 1, this.boundingBox.minZ - 1, EnumFacing.NORTH, i);
                if (mineshaftpieces$piece != null) {
            ...
            for(k = 0; k < this.boundingBox.getXSize(); k = k + 4) {
                ...
                StructureCrystalLabirynthPieces.Piece mineshaftpieces$piece1 = StructureCrystalLabirynthPieces.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX + k, this.boundingBox.minY + rand.nextInt(j) + 1, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, i);
            ...
            for(k = 0; k < this.boundingBox.getZSize(); k = k + 4) {
                ...
                StructureCrystalLabirynthPieces.Piece mineshaftpieces$piece2 = StructureCrystalLabirynthPieces.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY + rand.nextInt(j) + 1, this.boundingBox.minZ + k, EnumFacing.WEST, i);
            ...
            for(k = 0; k < this.boundingBox.getZSize(); k = k + 4) {
                ...
                StructurePiece structurepiece = StructureCrystalLabirynthPieces.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY + rand.nextInt(j) + 1, this.boundingBox.minZ + k, EnumFacing.EAST, i);
    ...
    public static class Stairs extends StructureCrystalLabirynthPieces.Piece {
        public Stairs() {
        }

        public Stairs(int p_i47136_1_, Random p_i47136_2_, MutableBoundingBox p_i47136_3_, EnumFacing p_i47136_4_) {
            super(p_i47136_1_);
        ...
        public void buildComponent(StructurePiece componentIn, List<StructurePiece> listIn, Random rand) {
            ...
            if (enumfacing != null) {
                switch(enumfacing) {
                    case NORTH:
                    default:
                        StructureCrystalLabirynthPieces.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX, this.boundingBox.minY, this.boundingBox.minZ - 1, EnumFacing.NORTH, i);
                        break;
                    case SOUTH:
                        StructureCrystalLabirynthPieces.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX, this.boundingBox.minY, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, i);
                        break;
                    case WEST:
                        StructureCrystalLabirynthPieces.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.minZ, EnumFacing.WEST, i);
                        break;
                    case EAST:
                        StructureCrystalLabirynthPieces.generateAndAddPiece(componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY, this.boundingBox.minZ, EnumFacing.EAST, i);
                }
            }
