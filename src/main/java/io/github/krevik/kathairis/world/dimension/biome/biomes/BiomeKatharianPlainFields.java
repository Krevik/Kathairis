...
public class BiomeKatharianPlainFields extends BiomeKatharianBiomeBase {
    ...
    public BiomeKatharianPlainFields() {
        ...
        this.addFeature(GenerationStage.Decoration.LOCAL_MODIFICATIONS, createDecoratedFeature(KatharianFeatureList.FEATURE_SMALL_RUINS, IFeatureConfig.NO_FEATURE_CONFIG, Placement.CHANCE_HEIGHTMAP, new ChanceConfig(300)));
