...
public class SingleJigsawPieceNoAirIgnorance extends JigsawPiece {
    ...
    @Deprecated
    public SingleJigsawPieceNoAirIgnorance(String p_i51400_1_, List<StructureProcessor> p_i51400_2_) {
        this(p_i51400_1_, p_i51400_2_, JigsawPattern.PlacementBehaviour.RIGID);
    }

    public SingleJigsawPieceNoAirIgnorance(String location, List<StructureProcessor> processors, JigsawPattern.PlacementBehaviour p_i51401_3_) {
        super(p_i51401_3_);
    ...
    @Deprecated
    public SingleJigsawPieceNoAirIgnorance(String location) {
        this(location, ImmutableList.of());
    }

    public SingleJigsawPieceNoAirIgnorance(Dynamic<?> p_i51403_1_) {
        super(p_i51403_1_);
