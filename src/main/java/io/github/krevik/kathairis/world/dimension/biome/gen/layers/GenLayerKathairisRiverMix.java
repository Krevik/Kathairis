 ...
 * @author Krevik
 */
public enum GenLayerKathairisRiverMix implements IAreaTransformer2, IDimOffset0Transformer {
	INSTANCE;
	...
	public int apply(IContext p_202709_1_, AreaDimension p_202709_2_, IArea p_202709_3_, IArea p_202709_4_, int p_202709_5_, int p_202709_6_) {
		...
		if (KathairisLayerUtil.isOcean(lvt_7_1_)) {
			return lvt_7_1_;
		} else if (lvt_8_1_ == IRegistry.BIOME.getId(ModBiomes.KATHARIS_RIVER)) {
