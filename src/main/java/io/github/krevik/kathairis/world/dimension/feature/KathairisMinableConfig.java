 ...
 * @author Krevik
 */
public class KathairisMinableConfig implements IFeatureConfig {
	...
	public KathairisMinableConfig(Predicate<IBlockState> p_i48673_1_, IBlockState p_i48673_2_, int p_i48673_3_) {
