 ...
 * @author Krevik
 */
public class FeatureBasicKathairisTree extends AbstractKathairisTreeFeature {

	private final boolean useExtraRandomHeight;

	public FeatureBasicKathairisTree(boolean notify, boolean useExtraRandomHeightIn) {
		super(notify);
