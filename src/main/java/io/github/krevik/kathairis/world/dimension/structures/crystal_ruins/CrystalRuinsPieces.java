...
public class CrystalRuinsPieces {
    ...
    static{
        ...
        JigsawManager.REGISTRY.register(new JigsawPattern(new ResourceLocation("crystal_ruins/stairs"), new ResourceLocation("empty"), ImmutableList.of(Pair.of(new SingleJigsawPiece("crystal_ruins/stairs/stairs_01"), 1)), JigsawPattern.PlacementBehaviour.RIGID));
        JigsawManager.REGISTRY.register(new JigsawPattern(new ResourceLocation("crystal_ruins/entrances"), new ResourceLocation("empty"), ImmutableList.of(Pair.of(new SingleJigsawPiece("crystal_ruins/entrances/entrance_01"), 1)), JigsawPattern.PlacementBehaviour.RIGID));
        JigsawManager.REGISTRY.register(new JigsawPattern(new ResourceLocation("crystal_ruins/crossings"), new ResourceLocation("empty"), ImmutableList.of(Pair.of(new SingleJigsawPiece("crystal_ruins/crossings/crossing_01"), 1)), JigsawPattern.PlacementBehaviour.RIGID));
