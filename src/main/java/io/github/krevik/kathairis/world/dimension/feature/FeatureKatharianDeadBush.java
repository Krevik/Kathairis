...
public class FeatureKatharianDeadBush extends Feature<NoFeatureConfig> {
    private static final BlockKathairisDeadGrass field_197166_a = (BlockKathairisDeadGrass) ModBlocks.KATHAIRIS_DEAD_GRASS;

    public FeatureKatharianDeadBush(Function<Dynamic<?>, ? extends NoFeatureConfig> p_i49878_1_) {
        super(p_i49878_1_);
    }
