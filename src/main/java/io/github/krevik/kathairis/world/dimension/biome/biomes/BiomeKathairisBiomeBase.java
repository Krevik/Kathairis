 ...
 */
//TODO: remove
public class BiomeKathairisBiomeBase extends Biome {

	public Color baseGrassColor = new Color(66, 244, 238);

	protected BiomeKathairisBiomeBase(BiomeBuilder builder) {
		super(builder);
		//this.addFeature(GenerationStage.Decoration.LOCAL_MODIFICATIONS, createCompositeFeature(KathairisFeatureList.KATHARIAN_CRYSTAL_CHAMBER, IFeatureConfig.NO_FEATURE_CONFIG, COUNT_RANGE, new CountRangeConfig(1, 0, 0, 128)));
	}
	...
	public int getGrassColor(BlockPos pos) {
		...
		for (BlockPos positionForAverage : toCalculate) {
			if (world.getBiome(positionForAverage) instanceof BiomeKathairisBiomeBase) {
				BiomeKathairisBiomeBase biome = (BiomeKathairisBiomeBase) world.getBiome(positionForAverage);
				count++;
