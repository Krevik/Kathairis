 ...
 * @author Krevik
 */
public class KathairisTreeFeature extends AbstractKathairisTreeFeature {
	...
	public KathairisTreeFeature(boolean p_i2027_1_) {
		this(p_i2027_1_, 4, MYSTIC_LOG.getDefaultState(), MYSTIC_LEAVES.getDefaultState(), false);
	}

	public KathairisTreeFeature(boolean notify, int minTreeHeightIn, IBlockState woodMeta, IBlockState p_i46446_4_, boolean growVines) {
		super(notify);
	...
	public KathairisTreeFeature setSapling(net.minecraftforge.common.IPlantable sapling) {
	...
	private boolean isValidGround(IWorld world, BlockPos pos) {
		...
		return block == KATHAIRIS_GRASS || block == KATHAIRIS_DIRT || block == Blocks.GRASS_BLOCK || block == Blocks.DIRT;
	}
