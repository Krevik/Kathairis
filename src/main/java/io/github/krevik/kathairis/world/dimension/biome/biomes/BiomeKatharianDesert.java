...
public class BiomeKatharianDesert extends BiomeKatharianBiomeBase{
    ...
    public BiomeKatharianDesert() {
        ...
        this.addFeature(GenerationStage.Decoration.LOCAL_MODIFICATIONS, createCompositeFeature(Feature.LAKES, new LakesConfig(ModBlocks.SOFT_SAND), LAVA_LAKE, new LakeChanceConfig(15)));
