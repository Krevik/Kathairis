 ...
 * @author Krevik
 */
public class KathairisWorldCaveCarver extends WorldCarver<ProbabilityConfig> {

	public KathairisWorldCaveCarver() {
		this.terrainBlocks = ImmutableSet.of(KATHAIRIS_GRASS, KATHAIRIS_DIRT, KATHAIRIS_STONE, KATHAIRIS_SAND,
				SOFT_SAND, KATHAIRIS_SANDSTONE, Blocks.STONE, Blocks.DIRT, Blocks.ANDESITE, Blocks.DIORITE, Blocks.GRAVEL);
	}
							...
							for (int lvt_40_1_ = lvt_24_1_; lvt_40_1_ > lvt_23_1_; --lvt_40_1_) {
								...
								if (lvt_41_1_ > -0.7D && lvt_33_1_ * lvt_33_1_ + lvt_41_1_ * lvt_41_1_ + lvt_37_1_ * lvt_37_1_ < 1.0D) {
									...
									if (!bitSet.get(lvt_43_1_)) {
										...
										if (lvt_44_1_.getBlock() == KATHAIRIS_GRASS) {
											lvt_39_1_ = true;
										}
										...
										if (this.isTargetSafeFromFalling(lvt_44_1_, lvt_45_1_)) {
											if (lvt_40_1_ < 11) {
												...
												if (lvt_39_1_) {
													...
													if (world.getBlockState(lvt_30_1_).getBlock() == KATHAIRIS_DIRT) {
