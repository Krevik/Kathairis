...
public class KatharianTreeFeatureConfig extends BaseKatharianTreeFeatureConfig {
    ...
    public static class Builder extends BaseTreeFeatureConfig.Builder {
        ...
        public KatharianTreeFeatureConfig.Builder func_227353_a_(List<TreeDecorator> p_227353_1_) {
            this.field_227340_d_ = p_227353_1_;
            return this;
        }

        public KatharianTreeFeatureConfig.Builder func_225569_d_(int p_225569_1_) {
            this.field_227341_e_ = p_225569_1_;
            return this;
        }

        public KatharianTreeFeatureConfig.Builder func_227354_b_(int p_227354_1_) {
            this.field_227342_f_ = p_227354_1_;
            return this;
        }

        public KatharianTreeFeatureConfig.Builder func_227355_c_(int p_227355_1_) {
            this.field_227343_g_ = p_227355_1_;
            return this;
        }

        public KatharianTreeFeatureConfig.Builder func_227356_e_(int p_227356_1_) {
            this.field_227344_h_ = p_227356_1_;
            return this;
        }

        public KatharianTreeFeatureConfig.Builder func_227357_f_(int p_227357_1_) {
            this.field_227345_i_ = p_227357_1_;
            return this;
        }

        public KatharianTreeFeatureConfig.Builder func_227358_g_(int p_227358_1_) {
            this.field_227346_j_ = p_227358_1_;
            return this;
        }

        public KatharianTreeFeatureConfig.Builder func_227359_h_(int p_227359_1_) {
            this.field_227347_k_ = p_227359_1_;
            return this;
        }

        public KatharianTreeFeatureConfig.Builder func_227360_i_(int p_227360_1_) {
            this.field_227348_l_ = p_227360_1_;
            return this;
        }

        public KatharianTreeFeatureConfig.Builder func_227361_j_(int p_227361_1_) {
            this.field_227349_m_ = p_227361_1_;
            return this;
        }

        public KatharianTreeFeatureConfig.Builder func_227362_k_(int p_227362_1_) {
            this.field_227350_n_ = p_227362_1_;
            return this;
        }

        public KatharianTreeFeatureConfig.Builder func_227352_a_() {
            this.field_227351_o_ = true;
            return this;
        }

        @Override
        public KatharianTreeFeatureConfig.Builder setSapling(net.minecraftforge.common.IPlantable value) {
            super.setSapling(value);
            return this;
        }

        public KatharianTreeFeatureConfig func_225568_b_() {
            return new KatharianTreeFeatureConfig(this.field_227377_a_, this.field_227378_b_, this.field_227339_c_, this.field_227340_d_, this.field_227341_e_, this.field_227342_f_, this.field_227343_g_, this.field_227344_h_, this.field_227345_i_, this.field_227346_j_, this.field_227347_k_, this.field_227348_l_, this.field_227349_m_, this.field_227350_n_, this.field_227351_o_).setSapling(this.sapling);
        }
    }
}