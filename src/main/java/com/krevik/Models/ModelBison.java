...
public class ModelBison extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) { 
        ...
        GlStateManager.translate(this.HornLeft.offsetX, this.HornLeft.offsetY, this.HornLeft.offsetZ);
        GlStateManager.translate(this.HornLeft.rotationPointX * f5, this.HornLeft.rotationPointY * f5, this.HornLeft.rotationPointZ * f5);
        ...
        GlStateManager.pushMatrix();
        GlStateManager.translate(this.LeftThigh.offsetX, this.LeftThigh.offsetY, this.LeftThigh.offsetZ);
        GlStateManager.translate(this.LeftThigh.rotationPointX * f5, this.LeftThigh.rotationPointY * f5, this.LeftThigh.rotationPointZ * f5);
        GlStateManager.scale(1.1D, 1.2D, 1.2D);
        GlStateManager.translate(-this.LeftThigh.offsetX, -this.LeftThigh.offsetY, -this.LeftThigh.offsetZ);
        GlStateManager.translate(-this.LeftThigh.rotationPointX * f5, -this.LeftThigh.rotationPointY * f5, -this.LeftThigh.rotationPointZ * f5);
        ...
        GlStateManager.pushMatrix();
        GlStateManager.translate(this.HornRight.offsetX, this.HornRight.offsetY, this.HornRight.offsetZ);
        GlStateManager.translate(this.HornRight.rotationPointX * f5, this.HornRight.rotationPointY * f5, this.HornRight.rotationPointZ * f5);
        GlStateManager.scale(1.6D, 1.2D, 1.0D);
        GlStateManager.translate(-this.HornRight.offsetX, -this.HornRight.offsetY, -this.HornRight.offsetZ);
        GlStateManager.translate(-this.HornRight.rotationPointX * f5, -this.HornRight.rotationPointY * f5, -this.HornRight.rotationPointZ * f5);
        ...
        GlStateManager.pushMatrix();
        GlStateManager.translate(this.RightThigh.offsetX, this.RightThigh.offsetY, this.RightThigh.offsetZ);
        GlStateManager.translate(this.RightThigh.rotationPointX * f5, this.RightThigh.rotationPointY * f5, this.RightThigh.rotationPointZ * f5);
        GlStateManager.scale(1.1D, 1.2D, 1.2D);
        GlStateManager.translate(-this.RightThigh.offsetX, -this.RightThigh.offsetY, -this.RightThigh.offsetZ);
        GlStateManager.translate(-this.RightThigh.rotationPointX * f5, -this.RightThigh.rotationPointY * f5, -this.RightThigh.rotationPointZ * f5);
