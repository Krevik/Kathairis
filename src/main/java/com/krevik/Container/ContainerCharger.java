package com.krevik.Container;

import com.krevik.Main.KCore;
import com.krevik.Slot.SlotChargerFuel;
...
public class ContainerCharger extends Container
{
    ...
    public ContainerCharger(InventoryPlayer playerInventory, IInventory furnaceInventory)
    {
        this.tileFurnace = furnaceInventory;
        this.addSlotToContainer(new Slot(furnaceInventory, 0, 11, 15));
        this.addSlotToContainer(new SlotChargerFuel(furnaceInventory, 1, 11, 54));
        this.addSlotToContainer(new SlotChargerOutput(playerInventory.player, furnaceInventory, 2, 152, 15));
