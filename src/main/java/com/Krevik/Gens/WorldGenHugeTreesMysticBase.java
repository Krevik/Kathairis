...
public abstract class WorldGenHugeTreesMysticBase extends WorldGenAbstractBasicMysticTree
{
    ...
    public WorldGenHugeTreesMysticBase(boolean notify, int baseHeightIn, int extraRandomHeightIn, IBlockState woodMetadataIn, IBlockState leavesMetadataIn)
    {
        super(notify);
    ...
    private boolean ensureDirtsUnderneath(BlockPos pos, World worldIn)
    {
        ...
        boolean isSoil = (state.getBlock().getDefaultState()==KCore.CorruptedDirt.getDefaultState() || state.getBlock().getDefaultState()==KCore.CorruptedGrass.getDefaultState());
