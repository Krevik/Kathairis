...
public class BlockMysticCrops extends BlockMysticBush implements IGrowable
{
    ...
    protected static final AxisAlignedBB[] CROPS_AABB = new AxisAlignedBB[] {
    		new AxisAlignedBB(0.35D, 0.0D, 0.35D, 0.65D, 0.125D, 0.65D),
    		new AxisAlignedBB(0.35D, 0.0D, 0.35D, 0.65D, 0.25D, 0.65D),
    		new AxisAlignedBB(0.35D, 0.0D, 0.35D, 0.65D, 0.4D, 0.65D),
    		new AxisAlignedBB(0.35D, 0.0D, 0.35D, 0.65D, 0.5D, 0.65D),
    		new AxisAlignedBB(0.35D, 0.0D, 0.35D, 0.65D, 0.6D, 0.65D),
    		new AxisAlignedBB(0.30D, 0.0D, 0.30D, 0.7D, 0.7D, 0.7D),
    		new AxisAlignedBB(0.25D, 0.0D, 0.25D, 0.75D, 0.75D, 0.75D),
    		new AxisAlignedBB(0.2D, 0.0D, 0.2D, 0.8D, 0.75D, 0.8D),
    		new AxisAlignedBB(0.15D, 0.0D, 0.15D, 0.85D, 0.75D, 0.85D),
